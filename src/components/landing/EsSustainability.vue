          ...
          <div class="columns">
            <div class="column is-6 is-offset-3">
              <h1 class="title is-1">
                ...
                Sustentabilidad de ForkDot
              </h1>
              <h1 class="subtitle">
                micro-dao-bedrock-bootstrap-experimento
              </h1>
              <p>
                Como parte de nuestro micro-dao-bootstrap-experimento, nos gustaría mantener nuestros esfuerzos sostenibles <b>en el largo plazo y crear esa confianza de la cultura </b> y la economía de los creadores para ForkDot y darles esa seguridad de que no desapareceremos mañana y seguiremos funcionando mientras podamos cubrir nuestros esfuerzos para mantenerlo en línea y funcionando.
              </p><br>
              <p>
              ...
              <p>
                Nuestro flujo de los fondos estará dividio en 3 partes: <b>Un programa para el apoyo de los Artistas, Costos de funcionamiento y para el Costo de la investigacion y desarrollo de ForkDot.</b> Desde el inicio, vamos a poner una parte de nuestros ahorros en el fondo de bedrock.
              </p><br>
              <p>
                <a href="https://github.com/kodadot/nft-gallery/issues/141">
                Los costos por el funcionamento de</a> de ForkDot consisten en pagar Netlify (http, cdn, CI&amp;CD), Pinata (IPFS), Arweave (por ahora es gratuito, despues tendremos que pagar), Textile.io (esperamos que este costo sea el mismo por un tiempo, y despues aumente).
                Mantenimiento, los costos de R&amp;D deben ser pagados a
                <a href="https://github.com/kodadot/nft-gallery/issues">our backlog of
                 medida que nuevas funciones en ForkDot vayan apareciendo</a> y estamos  <b>tratando de invitar a mas desarrolladores a nuestros circulos poniendo recompensas en problemas</b>.
                Cualquiera podrá unirse y ayudar con nuestro esfuerzo.
              </p><br>
              <p>
                Como nos gustaría establecer nuestro vector de acumulación para el fondo de sostenibilidad e introducir  <b>una pequeña tarifa gracias a que podra mintear su obra</b> a través de ForkDot, agregaremos un botón en el que aún puede optar por no participar voluntariamente y poder mintear su obra sin apoyarnos en lo absoluto.
              </p><br>
              <p>
                Para <b>devolver valor a la comunidad</b>, estamos a punto de establecer
                <b><a href="https://hackmd.io/cy3jpAhvR-S32SUiMqEabg?edit">un programa para el apoyo a los artistas </a></b> el cual fluirá de regreso a los artistas. Estamos tratando de crear un ciclo de acumulacion de autorefuerzo, donde usted, como creador que apoya la galería de ForkDot, el apoyo regresará y será destinado a nuevos artistas, creando así efectos de red para los primeros usuarios y la próxima ola de adoptantes, etc., Que luego podrían ser autopropulsados en algún momento si logramos desarrollar la estategia correcta.  Solo necesitamos jugar un poco más con las curvas de flujo correctas.  Es un experimento.
              </p><br>
              <p>
                Los poseedores actuales de multisig son los fundadores de ForkDot --
                <a href="https://twitter.com/yangwao">yangwao</a> &amp;
                <a href="https://twitter.com/vikiival">vikiival</a>
                y luego se expandirá, ya que creemos confianza con una comunidad mas amplia a la que le gustaria participar y adentrarse en ForkDot ya que esperamos que la tesoreria pueda crecer ampliamente algun dia.
              </p><br>
              <h1 class="title is-4">
